 ...
 * @author Pinedas
 */
public class FrmCategVuelo extends javax.swing.JInternalFrame {

    /**
     * Creates new form FrmCategVuelo
     */
    ...
    private void initComponents() {
        ...
        jtCategVuelo = new javax.swing.JTable();
        ...
        jtCategVuelo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtCategVuelo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jtCategVueloMousePressed(evt);
            }
        });
        jScrollPane2.setViewportView(jtCategVuelo);
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        adminA.setNombreArchivo("Reporte Categoria de Vuelo.csv");
        adminA.setContenido(MDIPrincipal.gCateg.getInfoReporte());
        adminA.escribir();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //Paso 2
        CategVuelo categVuelo = new CategVuelo();

        try {
            //Paso 3
            categVuelo.set_precio(Integer.parseInt(precio));
            categVuelo.set_descripcion(descripcion);
            if (this._agregando) { // agregara
                ...
                //Paso 4
                MDIPrincipal.gCateg.Agregar(categVuelo);
                ...
                codigo = this.txtCodigo.getText();
                //Paso 3.1
                categVuelo.set_codigo(Integer.parseInt(codigo));

                //Paso 4
                MDIPrincipal.gCateg.Modificar(this._indiceSeleccion, categVuelo);
            }
            //Paso 5
            actualizarElementosTabla();
            estadoBotones(true);
            ...
            AdminSerializacion.serializacion(MDIPrincipal.gCateg, "gCateg.obj");
        } catch (Exception e) {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        String _codigoCategVuelo = JOptionPane.showInputDialog("Ingrese el código");
        CategVuelo _categVueloEncontrado = MDIPrincipal.gCateg.BuscarPorCodigoGetElem(Integer.parseInt(_codigoCategVuelo));
        if (_categVueloEncontrado == null) {
            JOptionPane.showMessageDialog(this, "Elemento no encontrado");
        } else {
            mostrarElemento(_categVueloEncontrado);
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (_indiceSeleccion >= 0) {
            ...
            if (resultado == JOptionPane.YES_OPTION) {
                MDIPrincipal.gCateg.Eliminar(_indiceSeleccion);
                actualizarElementosTabla();
                //Paso 6: Serializar informacion
                AdminSerializacion.serializacion(MDIPrincipal.gCateg, "gCateg.obj");
            }
    ...
    private void jtCategVueloMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtCategVueloMousePressed
        // TODO add your handling code here:
        _indiceSeleccion = jtCategVuelo.getSelectedRow();
        if (_indiceSeleccion != -1) {
            CategVuelo _categVuelo = MDIPrincipal.gCateg.getElementoPorPosicion(_indiceSeleccion);
            mostrarElemento(_categVuelo);
        }
    }//GEN-LAST:event_jtCategVueloMousePressed
    ...
    public void actualizarElementosTabla() {
        // String codigo, precio, descripcion
        String[] titulos = {"Código", "precio", "Descripción"};
        DefaultTableModel dt = new DefaultTableModel(MDIPrincipal.gCateg.GetArrayGestion(), titulos);
        this.jtCategVuelo.setModel(dt);
    }
    ...
    private javax.swing.JTable jtCategVuelo;
